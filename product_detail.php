...
<html lang="en">
    ...
    <body>		
		<div id="top-bar" class="container">
			<div class="row">
				<div class="span4">
				<form action="top_seller.php" method="post" class="search_form">
		<input type="text" class="input-block-level search-query" Placeholder="E.g. T-sirt">
					</form>
				</div>
				<div class="span8">
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" id='gown' src="themes/images/carousel/banner-2.jpg" style='width:1000px; height:200px' alt="New products" >
				<h4 id='gownd'><span>Product-Details</span></h4>
      </section>
						...
						<ul class="thumbnails listing-products">
							<li class="span3">
								<div class="product-box">
									...
									<a href="product_detail.php" class="title">Sexy Top</a><br/>
							...
							<li class="span3">
								<div class="product-box">												
									...
									<a href="product_detail.php" class="title">Sliding Top & Short</a><br/>
									<a href="#" class="category">Best Seller</a>
							...
							<li class="span3">
								<div class="product-box">
									...
									<a href="product_detail.php" class="title">Flowing gown</a><br/>
							...
							<li class="span3">
								<div class="product-box">												
									...
									<a href="product_detail.php" class="title">Transparent Long Top</a><br/>
									<a href="#" class="category">Top Seller</a>
							...
							<li class="span3">
								<div class="product-box">                                        												
									...
									<a href="product_detail.php" class="title">Simple gown</a><br/>
									<a href="#" class="category">Best Seller</a>
							...
							<li class="span3">
								<div class="product-box">												
									...
									<a href="product_detail.php" class="title">Juicy Flexing gown</a><br/>
									<a href="#" class="category">Best Seller</a>
									<p class="price">#14,000</p>
									<button id='but'><a href='cart.php'><p>Buy</p></a></button>
								</div>
							...
							<li class="span3">
								<div class="product-box">												
									...
									<a href="product_detail.php" class="title">Fitted gown with belt</a><br/>
									<a href="#" class="category">Best Seller</a>
									<p class="price">#15,000</p>
									<button id='but'><a href='cart.php'><p>Buy</p></a></button>
								</div>
							...
							<li class="span3">
								<div class="product-box">												
									...
									<a href="product_detail.php" class="title">Long Top</a><br/>
									<a href="#" class="category">Top Seller</a>
							...
							<li class="span3">
								<div class="product-box">												
									...
									<a href="product_detail.php" class="title">Satire Flexing gown</a><br/>
									<a href="#" class="category">Best Seller</a>
										...
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">
													...
													<a href="product_detail.php" class="title">Beautiful Satire</a><br/>
													<a href="#" class="category">Top Seller</a>
													<p class="price">#15,000</p>
													<button id='but'><a href='cart.php'><p>Buy</p></a></button>
												</div>
							...
							<ul class="small-product">
								...
								<li>
									<a href="#" title="Top Seller Category">
										<img src="themes/images/ladies/4.jpg" alt="Top Seller Category">
									</a>
									<a href="#">Gucci Satire</a>
								</li>
								<li>
									<a href="#" title="Best Seller Category">
										<img src="themes/images/ladies/5.jpg" alt="Best Seller Category">
									</a>
									<a href="#">Flexible gown</a>
								</li>   
							</ul>
						</div>
					</div>
