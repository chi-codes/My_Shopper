			...
			<div class="row">
				<div class="span4">
					<form action="index.php" method="POST" class="search_form">
						<input type="text" class="input-block-level search-query" Placeholder="E.g Elegant gown">
					</form>
				</div>
				<div class="span8">
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>Elegant with fitted belt </td>
									<td><input type="text" placeholder="1" class="input-mini"></td>
									<td>#15,000</td>
									<td>#30,000</td>
								</tr>
								<tr>
									...
									<td>&nbsp;</td>
									<td>&nbsp;</td>
									<td><strong>#104,000.00</strong></td>
								</tr>		  
							</tbody>
						</table>
						<p class="cart-total right">
							<strong>Sub-Total</strong>:	#104,000.00<br>
							<strong>Total</strong>: #106,000.00<br>
						</p>
						<hr/> 
										...
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">
													...
													<a href="product_detail.php" class="title">Elegant Satire</a><br/>
										...
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">												
													...
													<a href="product_detail.php" class="title">Flexing Top</a><br/>
