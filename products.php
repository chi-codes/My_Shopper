    ...
    <body>		
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" id='pagepr'src="themes/images/carousel/banner-2.jpg" style='width:1000px; height:200px' alt="New products" >
				<h4 id='prod'><span>Highlighted Products</span></h4>
      </section>
				...
				<div class="row">						
					<div class="span9">								
						<ul class="thumbnails listing-products">
							...
							<li class="span3">
								<div class="product-box">												
									<a href="product_detail.php"><img alt="" src="themes/images/cloth/Clothings1.jpg"></a><br/>
							...
							<li class="span3">
								<div class="product-box">												
									<span class="sale_tag"></span>
									<a href="product_detail.php"><img alt="" src="themes/images/cloth/Power bank.jpg"></a><br/>
									<a href="product_detail.php" class="title">Power Bank</a><br/>
									<a href="#" class="category">Top Seller</a>
							...
							<li class="span3">
								<div class="product-box">												
									<a href="product_detail.php"><img alt="" src="themes/images/cloth/Solar1.jpg"></a><br/>
									<a href="product_detail.php" class="title">Mac Battery Solar</a><br/>
									<a href="#" class="category">Best Seller</a>
							...
							<li class="span3">
								<div class="product-box">												
									...
									<a href="product_detail.php" class="title">Satire Long Top</a><br/>
									<a href="#" class="category">Best Seller</a>
					...
					<div class="span3 col" iframe='20px;30px'>
						...
						<div class="block" id='fancybox-wrap'>								
							...
							<ul class="small-product">
								...
								<li>
									<a href="#" title="Best Seller Category">
										<img src="themes/images/cloth/wshoe8.jpg" alt="Best Seller Category">
									</a>
